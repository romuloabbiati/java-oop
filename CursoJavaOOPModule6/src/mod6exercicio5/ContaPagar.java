...
public class ContaPagar extends Conta {
	...
	public void pagar() throws OperacaoContaException {
		if (SituacaoConta.PAGA.equals(this.getSituacaoConta())) {
			throw new OperacaoContaException("Nao pode pagar uma conta que jah estah paga: " + this.getDescricao());
		} else if (SituacaoConta.CANCELADA.equals(this.getSituacaoConta())) {
			throw new OperacaoContaException("Nao pode pagar uma conta que estah cancelada: " + this.getDescricao());
		} else {
